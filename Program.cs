...
namespace GitPull_Merge
{
	internal class Program
	{
		static void Main(string[] args)
		{
            ...
            #region 
            //Bir array yaradin,o arraydaki ededlerin cemini ve ededi ortasini tapin
			...
			Console.WriteLine("x2'i daxil edin: ");
			int x2= Convert.ToInt32(Console.ReadLine());
			Console.WriteLine("y2'i daxil edin: ");
			int y2 = Convert.ToInt32(Console.ReadLine());

			Console.WriteLine("x3'i daxil edin: ");
			int x3 = Convert.ToInt32(Console.ReadLine());
			Console.WriteLine("y3'i daxil edin: ");
			int y3= Convert.ToInt32(Console.ReadLine());

            if ((y2-y1) / (x2- x1) == (y3 - y2) / (x3-x2)&&(y3 - y2) / (x3 - x2)==(y3-y1)/(x3-x1))
            {
                Console.WriteLine("Noqteler bir duz xett uzerindedir");
            }
            else
            {
                Console.WriteLine("Noqteler bir duz xett uzerinde deyil");
            }
